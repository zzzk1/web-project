    ...
    <div>
        ...
        <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
            <div style="width: 300px; display: flex; padding-left: 30px">
                ...
                <div style="flex: 1">欢迎来到mall系统</div>
            </div>
            <div style="flex: 1">
...
<!--                        </el-submenu>-->
<!--                    </el-submenu>-->
                    <el-menu-item index="/front/message"><a target="_blank">消息中心</a></el-menu-item>
                    <el-menu-item index="/front/order"><a target="_blank">订单管理</a></el-menu-item>
                </el-menu>
            </div>
